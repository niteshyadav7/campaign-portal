    ...
    <Dialog open={open} onOpenChange={(val) => {
      ...
      <DialogContent className="max-w-[calc(100%-2rem)] border-0 bg-transparent p-0 shadow-none ring-0 sm:max-w-3xl">
        <PremiumDialogFrame
          ...
          description={`Permanently delete the workspace for ${brandName}.`}
          accent="violet"
        >
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-amber-200 bg-amber-50/70 p-4 text-sm text-amber-800">
              <div className="flex gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-amber-900">Warning: Cascade Deletion</h4>
                  <p className="mt-1 leading-relaxed">
                    This action is permanent and cannot be undone. Deleting this brand workspace will automatically:
                  </p>
                  <ul className="mt-2 list-disc list-inside space-y-1">
                    <li>Delete all campaigns associated with this brand.</li>
                    <li>Delete all influencer shortlists for those campaigns.</li>
                    <li>Unassign (disconnect) any team members registered under this brand.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <p className="text-sm text-slate-600">
              Are you absolutely sure you want to delete <span className="font-semibold text-slate-800">{brandName}</span>?
            </p>
